...
export default {
    ...
    withdraw: {
        ...
        pre_moderation_notice_accepted: '<strong>{{documentType.pluralCapitalized}} are a permanent part of the scholarly record. Withdrawal requests are subject to this service’s policy on {{documentType.singular}} removal and at the discretion of the moderators.</strong><br>This service uses pre-moderation. This request will be submitted to service moderators for review. If the request is approved, this {{documentType.singular}} will be replaced by a tombstone page with metadata and the reason for withdrawal. This {{documentType.singular}} will still be searchable by other users after removal.',
        post_moderation_notice: '<strong>{{documentType.pluralCapitalized}} are a permanent part of the scholarly record. Withdrawal requests are subject to this service’s policy on {{documentType.singular}} removal and at the discretion of the moderators.</strong><br>This service uses post-moderation. This request will be submitted to service moderators for review. If the request is approved, this {{documentType.singular}} will be replaced by a tombstone page with metadata and the reason for withdrawal. This {{documentType.singular}} will still be searchable by other users after removal.',
        no_moderation_notice: '<strong>{{documentType.pluralCapitalized}} are a permanent part of the scholarly record. Withdrawal requests are subject to this service’s policy on {{documentType.singular}} removal and at the discretion of the moderators.</strong><br>This request will be submitted to support@cos.io for review and removal. If the request is approved, this {{documentType.singular}} will be replaced by a tombstone page with metadata and the reason for withdrawal. This {{documentType.singular}} will still be searchable by other users after removal.',
